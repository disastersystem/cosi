...
<main class="px-6" in:fly={{ y: 50, duration: 500, delay: 500 }} out:fly={{ duration: 500 }}>
    <div class="flex justify-center mt-40 mb-20">
        <div class="content-max-width">
            ...
            <p class="cosi-p">
                Please see our website for International Week for more information. <a href="https://www.ntnu.edu/lifeandhousing/gjovik/new-student" target="_blank" class="external break-all">https://www.ntnu.edu/lifeandhousing/gjovik/new-student</a>
            </p>
