...
<main class="px-6" in:fly={{ y: 50, duration: 500, delay: 500 }} out:fly={{ duration: 500 }}>
    <div class="flex justify-center mt-40 mb-20">
        <div class="content-max-width">
            ...
            <ul class="cosi-ul">
                <li>Résidence des Arts – Maison Internationale
                </li>
                <li>Résidence Néoréside Tréfilerie
                </li>
                <li>Résidence Néoréside Bellevue
                </li>
                <li>Résidence Le Littré
                </li>
                <li>Résidence Les Estudines – Jules Ferry</li>
            </ul>
            ...
            <p class="cosi-p">The APL is calculated from the date of deposit of your application at the CAF (“Caisse Allocations Familiales”) and paid monthly on your French bank account.
            </p>
            ...
            <p class="cosi-p">The home insurance can be contracted from our banking partner upon arrival in France.</p>

            <h4 class="cosi-title-4 mt-10 mb-4">
                2. You need to officially commit to the Programme by completing a Letter of commitment in this online form.
            </h4>
            <p class="cosi-p">
            ...
            <p class="cosi-p">If not, you need to submit to the nearest French consulate of place of residence your application for an extended-stay visa, along with any supporting documents required by the consulate. Supporting documents are generally the following (this list varies from one country to another; you should always contact and consult the relevant consular authority of your place of residence):
            </p>
            ...
            <p class="text-xs uppercase font-bold">N.B.1.</p>
            <p class="cosi-p">The same process must be undertake and type of visa requested in case you plan to work in France during the work placement to complete the Master Thesis in Semester 4. A 1 year Extended-stay student visa, with residency permit (VLS-TS) is better even if you plan to stay less than six months because it makes you eligible to the housing allowance.</p>
            <p class="text-xs uppercase font-bold">N.B.2.</p>
            ...
            <p class="cosi-p">
                You can also find information on the EU Immigration Portal regarding the visa application process.
            </p>
            ...
            <ul class="cosi-ul">
                ...
                <li>see this page for details (guarantor, forms, …)
                </li>
            </ul>
            ...
            <p class="cosi-p">
                Train tickets can be purchased upon arrival directly at the train station by cash or online (and delivered to your home country). Train tickets are usually available only 3 months before the date of departure. If you book online, don’t forget to print the ticket or reference number.
            </p>
            ...
            <ul class="cosi-ul">
                ...
                <li>Hotel Residhotel (from 19 EUR per night)
                </li>
                <li>Residence des Arts (from 45 EUR per night)</li>
            </ul>
