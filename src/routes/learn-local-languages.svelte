...
<main class="px-6" in:fly={{ y: 50, duration: 500, delay: 500 }} out:fly={{ duration: 500 }}>
    <div class="flex justify-center mt-40 mb-20">
        <div style="max-width: 766px;">
            ...
            <p class="cosi-p">
                Courses are offered by our partner <ExternalLink url="https://cilec.univ-st-etienne.fr/fr/">Centre International de Langue et Civilisation</ExternalLink> (CILEC).
            </p>
            <p class="cosi-p">
            ...
            <p class="cosi-p">
                Courses are offered by our partner <ExternalLink url="http://www.clm-granada.com/indexing.htm">Centro de lenguas</ExternalLink> (CLM).
            </p>
            <p class="cosi-p">
            ...
            <p class="cosi-p">
                As Erasmus+ beneficiaries, you can benefit from this <ExternalLink url="https://academy.europa.eu/local/euacademy/pages/course/community-overview.php?title=learn-a-new-language">language assessment / learning programme</ExternalLink>
            </p>
        </div>
    </div>
</main>
