<main class="px-6">
    <div class="flex justify-center mt-40 mb-20">
        <div style="max-width: 766px;">
            ...
            <ul class="cosi-ul">
                <li>Hasan SHEIKH FARIDUL defended his PhD on <span class="font-bold">"Analysis of 3D Color Matches for the Creation and Consumption of Video Content"</span>. He did his PhD at Technicolor. During his PhD he published several patents and papers. One of his papers on “Survey of Color Mapping and its Applications” was published in Stars in Eurographics 2014 . Hasan works now as a postdoctoral researcher at the Security & Content Protection Labs of Technicolor Research and Innovation.
                </li>
                <li>Raju SHRESTHA defended his PhD on <span class="font-bold">"Multispectral imaging: Fast acquisition, capability extension, and quality evaluation"</span> the 9th of December 2014. He published during his PhD 16 peer-reviewed scientific publications, including 3 journal papers.</li>
            </ul>
        </div>
    </div>
</main>
