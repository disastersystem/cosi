...
<script>
    ...
    const questions = [
        ...
        {
            question: 'I don\'t have the financial ability to finance this period of study. What are my options?',
            answer: `
                <p class="cosi-p">
        ...
        },
        {
            ...
            answer: `
                ...
                <p>
                <p class="cosi-p">
                    Please, see <a class="external" href="https://internacional.ugr.es/pages/politica-linguistica/tablasdecertificadosaceptadosporlaugr" target="_blank">this page</a>
        ...
        },
        {
            ...
            answer: `
                <p class="cosi-p">
                    Please check carefully <a class="external" href="/application/eligibility-criteria" target="_blank">this section</a> for academic background requirements.
                <p>
                <p class="cosi-p">
        ...
        {
            question: 'French visa: Do I need to apply to Campus France CEF in addition to the online application?',
            answer: `
                <p class="cosi-p">
                    ...
                    For more info on the CEF process and countries concerned, please visit these pages <a class="external" href="/france" target="_blank">france</a>, <a class="external" href="/spain" target="_blank">spain</a>, <a class="external" href="/norway" target="_blank">norway</a>, <a class="external" href="/finland" target="_blank">finland</a>.
                <p>
            `
        }
    ]
