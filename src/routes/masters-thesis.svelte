...
<main in:fly={{ y: 50, duration: 500, delay: 500 }} out:fly={{ duration: 500 }}>
            ...
            <div style="max-width: 750px;">
                ...
                <div class="mt-16">
                    ...
                    <p class="cosi-p cosi-text-light-purple">
                        A choice of MT topics/hosting institutions are available on <a href="https://ead-sciences.univ-st-etienne.fr/index.php?language=english" target="_self" class="external-dark">Claroline platform</a>.
                    </p>
                    <p class="cosi-p cosi-text-light-purple">
                        Check also <a href="http://erasmusintern.org/" target="_self" class="external-dark">ERASMUSINTERN</a>
                    </p>
                </div>
                ...
                <div class="mt-16">
                    ...
                    <p class="cosi-p cosi-text-light-purple">
                        Students fill in and send back to administrative coordinator the <a href="http://goo.gl/forms/Oe9HABDtBg" target="_self" class="external-dark">MT form</a> to allow us to edit a placement agreement. Ask to host institution and tell us if:
                    </p>
                    <ul class="cosi-ul">
    ...
    <div class="flex justify-center px-6 mt-20 mb-20">
        <div style="max-width: 766px;">
            ...
            <p class="cosi-p">
                In addition, you can apply to the <a target="_self" href="/scholarship/explora" class="external">Explo'ra scholarship</a> (please refer to the specific calendar for Master Thesis).
            </p>
        </div>
    </div>
</main>
