    ...
    <div class="flex justify-center mt-40 mb-20">
        <div style="max-width: 766px;">
            ...
            <div class="flex mb-6 mt-8">
                ...
                <div class="mr-6">
                    <h5 class="cosi-title-5 mb-4">Programme Country</h5>
                    <p class="cosi-p">4,500 €</p>
                    <p class="cosi-p">4,500 €</p>
                    <p class="cosi-p">9,000 €</p>
                </div>
                <div>
                    <h5 class="cosi-title-5 mb-4">Partner Country</h5>
                    <p class="cosi-p">9,000 €</p>
                    <p class="cosi-p">9,000 €</p>
                    <p class="cosi-p">18,000 €</p>
                </div>
            </div>
