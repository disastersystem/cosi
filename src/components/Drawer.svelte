...
<div class="relative z-40 lg:hidden" role="dialog" aria-modal="true">
    ...
    <div class="fixed inset-0 flex z-40">
        ...
        <form class="mt-4 border-t border-gray-200">
            ...
            <li>
                <a href="adwa" class="block px-2 py-3"> Backpacks </a>
            </li>

            <li>
                <a href="adwa" class="block px-2 py-3"> Travel Bags </a>
            </li>

            <li>
                <a href="adwa" class="block px-2 py-3"> Hip Bags </a>
            </li>

            <li>
                <a href="adwa" class="block px-2 py-3"> Laptop Sleeves </a>
            </li>
            </ul>
